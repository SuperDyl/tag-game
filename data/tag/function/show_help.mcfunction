...
tellraw @s [{"color":"green","text":"Set cooldown with unit: "},{"color":"yellow","text":"TICKS","clickEvent":{"action":"suggest_command","value":"/function tag:update_cooldown {conversion:1,cooldown:#ticks_here#}"},"hoverEvent":{"action":"show_text","contents":"Click to set"}},{"color":"green","text":", "},{"color":"yellow","text":"SECONDS","clickEvent":{"action":"suggest_command","value":"/function tag:update_cooldown {conversion:20,cooldown:#seconds_here#}"},"hoverEvent":{"action":"show_text","contents":"Click to set"}},{"color":"green","text":", "},{"color":"yellow","text":"MINUTES","clickEvent":{"action":"suggest_command","value":"/function tag:update_cooldown {conversion:1200,cooldown:#minutes_here#}"},"hoverEvent":{"action":"show_text","contents":"Click to set"}}]
